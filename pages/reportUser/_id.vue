        ...
        <div class="relative-container">
            <div class="report-id-page form-page section section-page">
                <div class="content">
                    ...
                    <h1 class="page-title">Report User</h1>
                    ...
                    <div class="form-container">
                        <form @submit.prevent action="#" class="form">
                            ...
                            <div class="input-group">
                                ...
                                <textarea @input="autoGrow" v-model="info" id="info" name="info" cols="30" wrap="soft" placeholder="Provide accurate info"></textarea>
                            </div>
                            <button @click="report" @submit="report" type="submit" class="btn btn-gradient btn-medium"><span>Report</span></button>
                        </form>
                    </div>
                </div>
                <img src="@/assets/img/reportUserComposition.png" alt="Report" class="form-image">
